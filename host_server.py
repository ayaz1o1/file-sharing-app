...
# Replaces the deprecated cgi module for parsing multi-part file uploads safely
from email.parser import BytesParser
from email.policy import default

# SET YOUR SHARED DIRECTORY HERE
# This is where files uploaded from your phone will be saved on your laptop
...
class DesktopShareHandler(SimpleHTTPRequestHandler):
    ...
    def list_directory(self, path):
        ...
        <head>
            ...
            <title>P2P File Share Dashboard</title>
            <style>
        ...
        <body>
            <div class="container">
                ...
                <h2>Available Files on Laptop</h2>
                <ul class="file-list">
        """
...
def get_wired_ip():
    try:
        # Grabs your active wired network interface adapter address dynamically
...
if __name__ == '__main__':
    ...
    my_ip = get_wired_ip()
    print("==================================================")
    print("⚡ DESKTOP FILE PORTAL IS RUNNING ⚡")
    print(f"👉 Open your phone's browser and go to: http://{my_ip}:{PORT}")
    print(f"📁 Shared Folder Path: {SHARED_DIR}")
    print("==================================================")
